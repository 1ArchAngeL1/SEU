...
export default function PolicyPage() {
  ...
  return (
    <main>
      {/* Dark Hero */}
      <div className="bg-site-bg py-12">
        <div className="max-w-[1920px] mx-auto px-5 lg:px-10">
          <FadeIn direction="left" duration={900}>
            <h1 className="font-[--font-bodoni] font-normal text-seu-heading lg:text-seu-title-xl leading-tight lg:leading-[6rem] text-site-fg mb-4 py-6 lg:py-10">
              {t('title')}
            </h1>
          </FadeIn>
        </div>
