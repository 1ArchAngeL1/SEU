      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-light text-[#0c1829] mb-6">
              SEU VAJA
            </h2>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#0c1829] text-sm">Modern Design</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#c9a962]/20 rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-[#c9a962]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-[#0c1829] text-sm">Prime Location</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#c9a962]/20 rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-[#c9a962]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-[#0c1829] text-sm">Premium Quality</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#c9a962]/20 rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-[#c9a962]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-[#0c1829] text-sm">Secure Living</span>
              </div>
            </div>
