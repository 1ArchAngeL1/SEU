        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-[#9ca3af] text-sm leading-relaxed mb-6">
              ...
              construction technologies with thoughtful architectural design.
            </p>
            ...
            <div className="w-full h-48 bg-[#0c1829] rounded-lg overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-10 h-10 bg-[#c9a962] rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-[#0c1829]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/10 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <nav className="flex flex-wrap justify-center gap-6 text-sm text-[#9ca3af]">
              ...
              <Link href="#news" className="hover:text-[#c9a962] transition-colors">News</Link>
