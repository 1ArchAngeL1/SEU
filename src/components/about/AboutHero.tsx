...
export default function AboutHero() {
  ...
  return (
    <div className="relative h-[calc(100dvh-5rem)] lg:h-[calc(100dvh-10rem)] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1920px] mx-auto px-5 lg:px-10 pt-16 lg:pt-24 flex items-start justify-between">
        ...
        <FadeIn direction="right" duration={900} className="hidden lg:block">
          <Image
